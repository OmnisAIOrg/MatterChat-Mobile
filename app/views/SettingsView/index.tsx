...
import YouHero from './components/YouHero';
...
const SettingsView = (): ReactElement => {
	...
	return (
		<View style={{ flex: 1 }} testID='settings-view'>
			{isMasterDetail ? null : <YouHero />}
			<ScreenSheet bottomInset={bottom} dockClearance={isMasterDetail ? 0 : DOCK_CLEARANCE}>
				<List.Container>
					{isMasterDetail ? (
						<>
							<List.Section>
			...
			{isMasterDetail ? null : <MainTabBar active='you' />}
		</View>
	);
};
